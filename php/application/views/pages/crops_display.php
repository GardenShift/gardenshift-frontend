            ...
            <div id ="AddCropDiv" title ="Add a crop">
                ...
                <form id="addform" class="appnitro"  method="post" action="">
                    ...
                    <table>	<tr>
                            ...
                            <td>
                                <label class="description" for="element_3" style="color:white;">Crop Name: </label>
                            </td>
                            <td>
                        ...
                        <tr><td>
                                <label class="description" for="element_1" style="color:white;">Quantity:</label>
                            </td>
                            <td>
                            ...
                            <td>
                                <label class="description" for="element_2_1" style="color:white;">Expected Harvest Date: </label></td>
                            <td>
                           ...
                           <tr>
                            <td>
                                <label class="description" for="element_4" style="color:white;">Comments: </label></td>
                            <td>

                                <TEXTAREA NAME="comments" COLS=25 ROWS=3 id="element_4" name="element_4" class="element text medium" value=""></TEXTAREA> 
                            </td>
                        </tr>
