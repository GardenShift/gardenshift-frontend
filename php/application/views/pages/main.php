...
<script src="../../js/showAllPictures.js" type="text/javascript"></script>
...
<style type="text/css">
      html { height: 100% }
      body { height: 100%; margin: 0; padding: 0; background-image: url("../../images/pattern.jpg"); }
...
<script>  
    ...
    function showPendingFriendRequests(){
     ...
     $("#pendingFriendsPopup").dialog('open');
 ...
 function viewProfile()
            ...
            success: function(response)        
            {
                 ...
                 var obj = jQuery.parseJSON(response);
                    ...
                    for(i= obj.user_crops.length - 1; i>=0 ; i--)
                     ...
                     // Update Currently growing crops
                   ...
                   // Update friend list
                    ...
                    for(i= obj.friends.length -1 ; i>=0 ; i--)
                     ...
                     if("<?php echo $this->session->userdata('username'); ?>" != name)
                     document.getElementById('friendsText').innerHTML += "<img src='../../images/addfriend.png' name='addfriends_bt' id='" + name +"' onclick=addFriends(this.id); style='width: 25px; height:25px; ' align='right' /> ";
                     }
                 ...
                 if("<?php echo $this->session->userdata('username'); ?>" != name)
                 {
                    document.getElementById('myCropsH2').innerHTML =  "Past Crops <img src='../../images/message.png' id='sendMessage_btn'  name = '"+ name +  "' style='width: 25px; height:25px; ' onclick='sendAMessage(this.name)' align = 'right'/>";
                    $("#addPicture_btn").hide();
               ...
               if(total_friends == 0)
                ...
                // Show picture albums of the visited user
                 ...
                 var msg = "<table cellpadding='0' style='width: 100px;' cellspacing='0' border='0' id='userCropsTableTab' width='50%'>";
                    ...
                    $("#UserCropsTab").remove();
                    $("#tabs-4").append("<div id='UserCropsTab'></div>");  
   ...
   $(document).ready( function() {
        ...
        $( "#addPicture_btn" ).button().click(function() {
            $('#albumPictureURL').dialog('open');
  ...
  animateClose : {height: 'toggle'}, // closing animation
   // easing
  text : 'Your message has been sent', // notification text
  type : 'notification', // noty type (alert, success, error)
  speed : 500, // opening & closing animation speed
  timeout : 5000, // delay for closing event. Set false for sticky notifications
  closeButton : true, // enables the close button when set to true
  ...
  modal : false// adds modal layer when set to true
                            ...
                            $('#searchField1').val("");
                             $('#element_3_msg').val("");
                             $("#sendMessageDivMainPage" ).dialog( "close" );
     ...
     $("#subid").hide( 'slow', function() {});
       ...
       $.ajax({
         url: 'http://test-gardenshift.rhcloud.com/index.php/pages/notification_populator',
        dataType: 'html',
        success: function(data) {
         
              $("#notifications1").html(data);
               $("#notifications1").show();
...
function updateNotifications() {
    $.ajax({
        ...
        success: function(data) {
           if(data!=0){
          // $('#notifications1').load('http://test-gardenshift.rhcloud.com/index.php/pages/mainPageLoader');    
...
<body id="MainBodyId">
    ...
    <div id="pictureURL">
        <form id="uploadImageForm"enctype="multipart/form-data" action="http://test-gardenshift.rhcloud.com/index.php/pages/upload_file" method="POST">
            <table>
                        <tr>
                            <td><label for="URL" align="left">URL:</label> </td>                             

                            <td><input type="text" name="username" id="pictureURLtxt" placeholder="Enter URL" align ="left"/></td>
                        </tr>
                            
                        <tr>   
                           <td><label for="URL" align="left">Please choose a file:</label> </td>
                               
                           <td><input name="uploaded" type="file" /><br /></td>
...
<!--    Menu-->
    ...
    <ul id="menu">
       ...
       <li><a href='javascript: ' id="notifications" style="width: 160px">Notifications <strong><b id ="subid" style="background:red; text:black; " ><?php if($bulletincount!=0){ echo '&nbsp;'; echo($bulletincount); echo '&nbsp;';}?>  </b></strong></a>
        <ul id="notifications1" style ="display:none; width: 280px">
...
<div id="page" >
    ...
    <div id="tabs" style=" position: absolute; top: 90px; left: 600px; width: 745px; z-index:0;">
	<ul>
		<li><a href="#tabs-1">Wall</a></li>
		<li><a href="#tabs-2">Pictures</a></li>
                <li><a href="#tabs-3">All Crops</a></li>
                <li><a href="#tabs-4">User Crops</a></li>
	</ul>
	<div id="tabs-1">
            
            <div id="content" style=" position:relative; left:20px; top:-10px; width:100%; background-image: url('../../images/content_bg.jpg'); background-size: 100%; background-repeat: repeat">
		
                <div id="status_bts">
		
                       <input type="text" name="status" id="status_txtbox" style= "width: 85%; height: 40px;" placeholder="What's going on in your farm?"/> 
                       <button name="status_bt" id="status_bt" value="POST" style= "height: 40px;" onclick=updateStatus();> Share </button> 
		</div>
            
                <div id="statusDiv" style="height: 100%;  min-height:800px; height:auto !important; ">
        ...
        <div id="tabs-2" style="position: relative; left: 1px; height:520px; width: 700px; z-index:0; background-image: url('../../images/content_bg.jpg'); background-size: 100%; background-repeat: repeat ">
           
                       <button id="addPicture_btn" onclick ="$('#albumPictureURL').dialog('open');" style="position: relative; top: 480px; left: 300px; z-index:999;">Add Picture</button> 
                    
                    <div  id="showcase" class="mygallery" style="position: absolute; left:60px;top: 30px; height:100%">
                            <div class="tn3 album">
                            </div>
        ...
        <div id="tabs-3" style="position: relative; left: 1px; height:100%; width: 700px; z-index:0; background-image: url('../../images/content_bg.jpg'); background-size: 100%; background-repeat: repeat ">
         ...
         <div id="tabs-4" style="position: relative; left: 1px; height:100%; width: 700px; z-index:0; background-image: url('../../images/content_bg.jpg'); background-size: 100%; background-repeat: repeat ">
           
           <div id="UserCropsTab"></div>
	...
	<div id="sidebar" style=" position: absolute; top: 85px; left: 250px; width: 300px; z-index:0;">
		...
		<div class="boxed">
			<h2 id="myCropsH2" class="title">Past Crops</h2>
		...
		<div class="boxed">
            ...
            <div class="boxed" id ="pendingFriendsPopup" style="display:none;">
			
                       
		</div>

		<div id="footer" >
			<p id="legal">&copy;2012 Gardenshift. All Rights Reserved<br />
				Design modified from <a href="http://www.freecsstemplates.org">FCT</a></p>
...
<div id="albumPictureURL">
        <form id="uploadImageFormAlbum"enctype="multipart/form-data" action="http://test-gardenshift.rhcloud.com/index.php/pages/upload_file_to_album" method="POST">
            <table>
                        ...
                        <tr>   
                           <td><label for="URL" align="left">Caption</label> </td>
                               
                           <td><input name="picture_caption" type="text" /><br /></td>
