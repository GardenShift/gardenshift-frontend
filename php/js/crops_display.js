// From                      Message                    
// Hilay Khatri              Changed the date format to store entire year
    ...
    $( "#AddCropDiv" ).dialog({
        ...
        buttons: {
            "I am growing it!": function() {
                ...
                var comments = document.getElementById("element_4").value;
                ...
                if ( bValid ) {
                    //  alert(1);
                        ...
                        $.ajax({
            type:"POST",
            url:"http://test-gardenshift.rhcloud.com/index.php/crop/addusercrop",
            data:{name:usern, crop_name:name, quantity:quantity, hdate:hdate,comments:comments },
